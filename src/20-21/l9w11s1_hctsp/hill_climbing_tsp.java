...
import l9w11s1_hctsp.CS2004;
import l9w11s1_hctsp.ScalesSolution;

public class hill_climbing_tsp {
	public static void main(String[] args) {
		ArrayList<Double> tPrimeNumbers = CS2004.ReadNumberFile("src\\l8w10s1_fftsp\\1000 Primes.txt"), weights = new ArrayList<Double>();
